...
def tic_tac_toe():
  ...
  # faz a análise no vetor board para verificar se há uma vitória.
  ...
  def verify_victory(move,mark):
    ...
    # A função line_row fixa uma coordenada e verifica se 3 valores seguidos dela
    # pertence ao jogador
    ...
    # Secciona o cubo em um plano e analisa cada uma das diagonais dele
